    ...
    <div class="mb-2">
        ...
        <div class=" my-3 ">
            ...
            <div class="row mb-2">
                ...
                <div class="form-floating col">
                    <input type="datetime" class="form-control datepicker" id="datepicker1"  placeholder="작성일자" name="rdate" value="${rdto.rdate }">
            ...
            <div class="row">
                ...
                <div class="form-floating col demo-usage-on-input-or-inline">
                    <input type="datetime" class="form-control datepicker" id="datepicker1" placeholder="확인일자" name="cdate" value="${rdto.cdate }">
