           ...
           <input type="hidden" value="${pdto.projectid }" name="projectid">
            ...
            <div class=" my-3 ">
                ...
                <div class="row mb-2">
                    ...
                    <div class="form-floating col">
                        <input type="datetime" class="form-control" id="demo-mobile-picker-input" placeholder="이름" name="startdate" readonly="readonly" value="${pdto.startdate }">
                        <label class="ml-2" for="floatingInput_date">과제 시작 </label>
                    </div>
    
                    <div class="form-floating col">
                        <input type="datetime" class="form-control" id="demo-mobile-picker-input" placeholder="이름" name="finishdate" readonly="readonly" value="${pdto.finishdate }">
                ...
                <div class="row mb-2">
                    <div class="form-floating col">
                        <input type="text" class="form-control" id="floatingInput_name" placeholder="이름" name="leader" readonly="readonly" value="${ leader}">
                ...
                <div class="row mb-2">
                    <div class="form-floating col">
                        <input type="text" class="form-control" id="floatingInput_name" placeholder="이름" name="researcher" readonly="readonly" value="${ researcher}">
